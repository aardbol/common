...
[![Bundle Size](https://img.shields.io/github/size/aardbol-actions/common/bundle-verifier/dist/index.js)](./dist/)
...
| `working_directory` | Working directory to use for relative path to `bundle_file`, and to run the `bundle_command` in.<br><br>For this repository, it is `bundle-verifier`. |
